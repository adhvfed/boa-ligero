...
fn run_jit(
    ...
    println!(
        concat!(
            ...
            "cold_compile_time_ns={} cold_native_entries={} cold_native_leaf_entries={} ",
            "cold_deopts={} ",
            ...
            "shim_compilations={} native_entries={} native_leaf_entries={} deopts={} ",
        ...
        cold_stats.native_leaf_entries,
        cold_stats.deopts,
